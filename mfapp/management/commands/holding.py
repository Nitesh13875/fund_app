...
# from mfapp.models import Fund, Portfolio, Holding,RiskVolatility,CSVData
...
#     ACCESS_TOKEN= "6A5fOTZnfeq6AME7BbFGFAusUf5b"
#
...
#         for fund_id in ids:
#             url = f"https://api-global.morningstar.com/sal-service/v1/fund/portfolio/holding/v2/{fund_id}/data?premiumNum=100&freeNum=25&hideesg=true&languageId=en&locale=en&clientId=RSIN_SAL&benchmarkId=mstarorcat&component=sal-mip-holdings&version=4.31.0&access_token={self.ACCESS_TOKEN}"
